    ...
    >
      <div className="texto-modal">
        ...
        <p className="modal-parrafo">
          1. Información que Recopilamos Recopilamos información personal de los
          usuarios a través de formularios en línea, interacciones con nuestros
          servicios y cualquier otro medio de contacto. La información que
          recopilamos incluye, pero no se limita a: Nombre completo Dirección de
          correo electrónico Número de teléfono Intereses o preferencias
          Información de pago (cuando corresponda)
        </p>
        <p className="modal-parrafo">
          2. Cómo Utilizamos su Información La información personal que
          recopilamos se utiliza para: Proporcionar los servicios ofrecidos por
          CEOP Business, incluyendo asesoría de tesis y otros servicios de
          consultoría. Procesar pagos y emitir facturas. Responder a consultas y
          solicitudes de los usuarios. Personalizar la experiencia del usuario,
          adaptando los servicios a sus intereses y necesidades. Enviar
          notificaciones sobre actualizaciones de nuestros servicios,
        ...
        <p className="modal-parrafo">
          ...
          compartimos, vendemos ni divulgamos su información personal a terceros
          sin su consentimiento, excepto en los siguientes casos: Cuando sea
          necesario para cumplir con obligaciones legales. Para proteger
          nuestros derechos y propiedades o los de nuestros usuarios. Cuando sea
          requerido para completar transacciones o proporcionar servicios a
          través de terceros proveedores, como procesadores de pago o servicios
        ...
        <p className="modal-parrafo">
          5. Sus Derechos Dependiendo de su ubicación, usted puede tener ciertos
          derechos sobre su información personal, incluidos: El derecho a
          acceder a los datos que CEOP Business tiene sobre usted. El derecho a
          solicitar la corrección de cualquier información inexacta o
          incompleta. El derecho a solicitar la eliminación de sus datos, salvo
          que existan motivos legales para conservarlos. El derecho a retirar su
          consentimiento en cualquier momento, si el procesamiento de sus datos
          se basa en el consentimiento. Si desea ejercer alguno de estos
          derechos, póngase en contacto con nosotros utilizando la información
        ...
        <p className="modal-parrafo">
          ...
          visita nuestro sitio. Puede configurar su navegador para rechazar las
          cookies, pero esto puede afectar la funcionalidad de nuestro sitio
          web.
        </p>
        <p className="modal-parrafo">
          ...
          cualquier momento. Los cambios serán efectivos inmediatamente tras su
          publicación en nuestro sitio web. Le recomendamos revisar
        ...
        <p className="modal-parrafo">
          ...
          contacto@ceopbusiness.com Dirección física: [Agregar dirección física]
        </p>
      </div>
