  ...
  return (
    ...
    >
      <div className="texto-modal">
        ...
        <br />
        <p>
          Estos Términos de Servicio rigen el uso de los servicios ofrecidos por
          CEOP Business. Al acceder o utilizar nuestros servicios, usted acepta
        ...
        <p className="modal-parrafo">
          ...
          Intereses. La información recopilada se utiliza para brindar servicios
          de asesoría y para comunicarnos con los usuarios.
        </p>
        <p className="modal-parrafo">
          3. Uso de la Información La información que recopilamos se utiliza
          para: Proporcionar nuestros servicios de asesoría de tesis. Responder
          a consultas y solicitudes de información. Mejorar nuestros servicios y
          la experiencia del usuario.
        </p>
        <p className="modal-parrafo">
          4. Confidencialidad Nos comprometemos a proteger la privacidad de su
          información personal. No compartiremos, venderemos ni divulgaremos su
          información a terceros sin su consentimiento, salvo que sea requerido
          por la ley.
        </p>
        <p className="modal-parrafo">
